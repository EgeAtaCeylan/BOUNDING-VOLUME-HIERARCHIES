...
int main(){
    ...
    /*
     ...
     string agent_file = "sample_run/agent.txt", actions_file = "sample_run/actions.txt";
     */
    
    //change test case number for different cases 1-11
    string agent_file = "test_cases/test_case_10/agent.txt", actions_file = "test_cases/test_case_10/actions.txt";
